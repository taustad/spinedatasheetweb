...
export const generateNoiseRowData = (
    datasheet: ElectricalTagData,
): TableRow[] => [
    {
        refClause: "",
        description:
            "Maximum permissible sound pressure at 1 m (3 ft) (sinewave, no load):",
        purchaserReq:
    ...
    },
    {
        ...
        purchaserReq:
            datasheet.electricalPurchaserRequirement
                ?.purchaserMaximumPermissibleNoiseLimit,
        purchaserReqUOM: "db(A)",
        supplierOfferedVal:
            datasheet.electricalSupplierOfferedProduct
                ?.purchaserMaximumPermissibleNoiseLimit,
    ...
    },
    {
        ...
        purchaserReq:
            datasheet.electricalPurchaserRequirement
                ?.maximumDeclaredMotorSoundPowerLevelAtNoLoad,
        purchaserReqUOM: "db(A)",
        supplierOfferedVal:
            datasheet.electricalSupplierOfferedProduct
                ?.maximumDeclaredMotorSoundPowerLevelAtNoLoad,
    ...
    },
    {
        ...
        purchaserReq:
            datasheet.electricalPurchaserRequirement
                ?.maximumExpectedMotorSoundPowerLevelAtFullLoad,
        purchaserReqUOM: "db(A)",
        supplierOfferedVal:
            datasheet.electricalSupplierOfferedProduct
                ?.maximumExpectedMotorSoundPowerLevelAtFullLoad,
    ...
    },
    {
        ...
        purchaserReq:
            datasheet.electricalPurchaserRequirement
                ?.noiseLevelTestAtOneMotorFromThisOrderBatch,
        purchaserReqUOM: "",
        supplierOfferedVal:
            datasheet.electricalSupplierOfferedProduct
                ?.noiseLevelTestAtOneMotorFromThisOrderBatch,
